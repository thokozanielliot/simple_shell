...
/**
 * _mycd - changes the current directory space
...
/**
 * _myhelp - this changes the current directory of the space
 * @info: A structure containing a potential argument. Used to maintain
 * a constant function prototype.
 * Return: Always 0
 */
int _myhelp(info_t *info)
{
	...
	arg_array = info->argv;
	_puts("help call works. Function is not implemented \n");
	if (0)
